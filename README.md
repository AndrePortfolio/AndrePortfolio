...
<ul>
  ...
  <li><a href="https://github.com/AndrePortfolio/finance_app">finance_app</a> - Developed a simulator of a brokerage account where users could buy and sell stocks, view their transaction history, and manage their portfolios. This project involved exploring and applying various sorting algorithms to efficiently sort data and enhance problem-solving skills. The app was built using HTML, CSS, JS, Python (Flask), and SQL for data management.</li>
