...
<p>
    Building on the knowledge acquired from <a href="https://github.com/AndrePortfolio/cpp_modules">cpp's</a>, I am currently working on a group project to develop an Internet Relay Chat <a href="https://github.com/AndrePortfolio/ft_irc">IRC</a> server in C++. This server will be fully compatible with an official client.
</p>
